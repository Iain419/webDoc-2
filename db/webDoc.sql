...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4228189733ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=webDoc&table=users">`webDoc`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=webDoc&table=privateDoctors">`webDoc`.`privateDoctors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=webDoc&table=schedules">`webDoc`.`schedules`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=webDoc&table=hospital">`webDoc`.`hospital`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=webDoc&table=userratings">`webDoc`.`userratings`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mobimechanic&table=mechanics">`mobimechanic`.`mechanics`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mobimechanic&table=hire">`mobimechanic`.`hire`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mobimechanic&table=user">`mobimechanic`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="webDoc" targettable="privateDoctors">
            ...
            Queried time
                            ...
                            <span class="query">SELECT privateDoctors.name FROM privateDoctors LEFT JOIN schedules on privateDoctors.name = schedules.doctorName WHERE privateDoctors.username = &#039;WandaMaximoff&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="privateDoctors">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM privateDoctors LEFT JOIN schedules on privateDoctors.name = schedules.doctorName WHERE privateDoctors.username = &#039;WandaMaximoff&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="privateDoctors">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `privateDoctors`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="schedules">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `schedules`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="userratings">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userratings`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="userratings">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userratings`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="hospital">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `hospital`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="userratings">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userratings`  
ORDER BY `userratings`.`hospitalName` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="userratings">
                            <div class="action_content">
...
ORDER BY `userratings`.`hospitalName` ASC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userratings`  
ORDER BY `userratings`.`hospitalName`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="userratings">
                            <div class="action_content">
...
ORDER BY `userratings`.`hospitalName`  DESC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userratings`  
ORDER BY `userratings`.`ratings` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="webDoc" targettable="hospital">
                            <div class="action_content">
